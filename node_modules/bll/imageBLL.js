...
exports.getImages = function(req, res, preId) {
    var returnImages = function(images) {
    ...
    if(preId) {
        ...
        imageDAL.findPageImagesSortByCreateTime(preId, numberPerPage, function(err, images) {
            if(err) {
